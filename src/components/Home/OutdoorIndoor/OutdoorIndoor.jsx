        ...
        <div className="pagecontent">
          <div className="indore">
            ...
            <p className="indoorcontent">
              ...
              holds in these matter to this principle of selection: he rejects
              pleasures to secure other greater pleasures, or else he endures
              pains to avoid worse pains."
            </p>
          </div>
          <div className="outdoor">
            <h1>this is outdoor content</h1>
            <img
              className="outdoorimg"
              src="https://images.unsplash.com/photo-1458442310124-dde6edb43d10?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80"
            />
            <p className="indoorcontent">
              "On the other hand, we denounce with righteous indignation and
          ...
          <div className="natural">
            <h1>this is natural content</h1>
            <img
              className="naturalimg"
              src="https://images.unsplash.com/photo-1458442310124-dde6edb43d10?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80"
            />
            <p className="indoorcontent">
              "On the other hand, we denounce with righteous indignation and
